          ...
          <div className="relative flex justify-center text-sm">
            ...
            <form action="" onSubmit={(e) => {
              ...
              signUpWithEmailAndPassword();
                ...
                <div>
                    <InputComponent Icon={PersonIcon} label={t("completeName")} placeholder={t("completeName")} type="text" value={credentials.nombre} onChange={(e) => setcredentials({...credentials, nombre: e.target.value})}/>
                    <InputComponent Icon={EmailIcon} label={t("email")} placeholder={t("emailplaceholder")} type="email" value={credentials.email} onChange={(e) => setcredentials({...credentials, email: e.target.value})}/>
                    <InputComponent Icon={LockIcon} label={t("password")} placeholder={t("passwordplaceholder")} type="password" value={credentials.password} onChange={(e) => setcredentials({...credentials, password: e.target.value})}/>
                    <InputComponent Icon={LockClockIcon} label={t("passwordConfirmation")} placeholder={t("passwordConfirmation")} type="password" value={credentials.passwordConfirmation} onChange={(e) => setcredentials({...credentials, passwordConfirmation: e.target.value})}/>
